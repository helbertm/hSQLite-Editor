...
export const I18N_BASE_MESSAGES = Object.freeze({
  "en-US": Object.freeze({
    ...
    "language.label": "Language", "language.description": "Choose the interface language.", "session.save": "Save session", "release.whatsNew": "What's new", "help.label": "Help", "issues.report": "Report a bug", "database.none": "No database loaded", "database.file": "Database file", "database.recent": "Recent", "database.new": "New",
    "session.description": "When enabled, hSQLite Editor stores open tabs, draft queries, history, favorites, and preferences locally in this browser. Use Settings to export or import them on another browser or device.", "theme.toggle": "Switch light or dark theme", "issues.tooltip": "Report a bug in GitHub Issues", "database.actions": "Database file actions", "database.openRecent": "Open recent databases", "database.openFile": "Choose a SQLite file", "database.newFile": "Create an empty database", "database.saveFile": "Save the current database",
  ...
  "es-ES": Object.freeze({
    ...
    "language.label": "Idioma", "language.description": "Elige el idioma de la interfaz.", "session.save": "Guardar sesión", "release.whatsNew": "Novedades", "help.label": "Ayuda", "issues.report": "Informar de un error", "database.none": "No hay ninguna base de datos cargada", "database.file": "Archivo de datos", "database.recent": "Recientes", "database.new": "Nueva",
    "session.description": "Cuando está activado, hSQLite Editor guarda localmente en este navegador las pestañas abiertas, consultas en edición, historial, favoritas y preferencias. Usa Configuración para exportar o importar estos datos en otro navegador o dispositivo.", "theme.toggle": "Cambiar entre tema claro y oscuro", "issues.tooltip": "Informar de un error en GitHub Issues", "database.actions": "Acciones del archivo de base de datos", "database.openRecent": "Abrir bases de datos recientes", "database.openFile": "Elegir un archivo SQLite", "database.newFile": "Crear una base de datos vacía", "database.saveFile": "Guardar la base de datos actual",
