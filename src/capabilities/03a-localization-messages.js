...
export const I18N_MESSAGE_ROWS = Object.freeze([
  ...
  , ["help.gridHtml", "<section><h4>1. Getting started</h4><div>Open a SQLite file, write SQL, and press <span class=\"kbd\">F5</span>.</div></section><section><h4>2. SQL workspace</h4><div>Use independent tabs, history, favorites, SQL files, and keyboard shortcuts.</div></section><section><h4>3. Schema</h4><div>Filter objects by name and type. Select columns to insert qualified identifiers.</div></section><section><h4>4. Results</h4><div>Sort, paginate, select, and export rows as CSV or JSON.</div></section><section><h4>5. Local data</h4><div>Session, history, favorites, and preferences stay in this browser.</div></section><section><h4>6. Offline mode</h4><div>The official standalone HTML works directly from <code>file://</code>.</div></section><section><h4>7. Issues</h4><div>Use Report a bug to open the project issue tracker.</div></section>", "<section><h4>1. Primeiros passos</h4><div>Abra um arquivo SQLite, escreva SQL e pressione <span class=\"kbd\">F5</span>.</div></section><section><h4>2. Área SQL</h4><div>Use abas independentes, histórico, favoritas, arquivos SQL e atalhos de teclado.</div></section><section><h4>3. Schema</h4><div>Filtre objetos por nome e tipo. Selecione colunas para inserir identificadores qualificados.</div></section><section><h4>4. Resultados</h4><div>Ordene, pagine, selecione e exporte registros como CSV ou JSON.</div></section><section><h4>5. Dados locais</h4><div>Sessão, histórico, favoritas e preferências permanecem neste navegador.</div></section><section><h4>6. Modo offline</h4><div>O HTML standalone oficial funciona diretamente em <code>file://</code>.</div></section><section><h4>7. Problemas</h4><div>Use Reportar erro para abrir o rastreador de issues do projeto.</div></section>", "<section><h4>1. Primeros pasos</h4><div>Abra un archivo SQLite, escriba SQL y pulse <span class=\"kbd\">F5</span>.</div></section><section><h4>2. Área SQL</h4><div>Use pestañas independientes, historial, favoritas, archivos SQL y atajos de teclado.</div></section><section><h4>3. Esquema</h4><div>Filtre objetos por nombre y tipo. Seleccione columnas para insertar identificadores cualificados.</div></section><section><h4>4. Resultados</h4><div>Ordene, pagine, seleccione y exporte filas como CSV o JSON.</div></section><section><h4>5. Datos locales</h4><div>La sesión, el historial, las favoritas y las preferencias permanecen en este navegador.</div></section><section><h4>6. Modo sin conexión</h4><div>El HTML autónomo oficial funciona directamente desde <code>file://</code>.</div></section><section><h4>7. Problemas</h4><div>Use Informar de un error para abrir el gestor de incidencias del proyecto.</div></section>"]
